            ...
            child: Row(
              children: [
                _buildFilterChip(
                  ...
                  0,
                  _filtroParticipacao,
                  (v) => setState(() => _filtroParticipacao = v),
                ),
          ...
          child: Row(
            ...
            children: [
              _buildFilterChip(
                ...
                0,
                _filtroOrganizacao,
                (v) => setState(() => _filtroOrganizacao = v),
              ),
              const SizedBox(width: 10),
              _buildFilterChip(
                'Histórico',
...
class _ModalGerenciarParticipantes extends StatefulWidget {
  ...
  const _ModalGerenciarParticipantes({
    required this.jantar,
    required this.onAtualizar,
  });

  @override
  State<_ModalGerenciarParticipantes> createState() =>
      _ModalGerenciarParticipantesState();
}

class _ModalGerenciarParticipantesState
    extends State<_ModalGerenciarParticipantes> {
  ...
  Future<void> _carregarParticipantes() async {
    try {
      ...
      debugPrint(
        "🔍 DEBUG: Carregando participantes do encontro ${widget.jantar.idEncontro}",
      );
      ...
      if (mounted) {
        ...
        debugPrint(
          "🔍 DEBUG: Participantes carregados: ${participantes.length}",
        );
      }
    } catch (e) {
